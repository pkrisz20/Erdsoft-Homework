...
<div class="centered">A birtok</div>
  ...
  <div class="row header-div">
    <img class="header" src="{{ asset('img/header-edited.jpg') }}">
  </div>
...
<div class="container-fulid">
  <div class="merged-div w-100">
    <img class="merged" src="{{ asset('img/merged.png') }}">
  </div>

  <div class="row winery">

    <div class="column">
      <img class="col-12" src="{{ asset('img/winery.jpg') }}">
    </div>
...
<div class="container">
  <div class="row two-images">
      ...
      <div>
        <img class="territory img-fluid" src="{{ asset('img/territory.jpg') }}">
      </div>
...
<div class="container-fluid">
  ...
  <div class="column1 slideshow-img">
    ...
    <img class="mySlides" src="{{ asset('uragya/uragya01.jpg') }}" style="width:100%">
    <img class="mySlides" src="{{ asset('uragya/uragya02.jpg') }}" style="width:100%">
    <img class="mySlides" src="{{ asset('uragya/uragya03.jpg') }}" style="width:100%">
    <img class="mySlides" src="{{ asset('uragya/uragya04.jpg') }}" style="width:100%">
    <img class="mySlides" src="{{ asset('uragya/uragya05.jpg') }}" style="width:100%">
    <img class="mySlides" src="{{ asset('uragya/uragya06.jpg') }}" style="width:100%">
...
<div class="container">
  ...
  <div class="row sor">
    ...
    <div class="column2">
        ...
        <div class="wine-div1 col-xl-9 col-lg-8 col-md-8 col-sm-8">
          <img class="bottles col-2" src="{{ asset('img/bottles.png') }}">
        </div>

      <div class="card4 mb-3">
        <div class="row g-0">
          <div class="col-md-4 col-sm-3 col-3 medals-img">
            <div class="gold-icon-filled"><img src="{{ asset('img/gold-decanter.png') }}" class="medals"></div>
            <div class="gold-icon-oulined"><img src="{{ asset('img/international_trophy.png') }}" class="medals"></div>
          </div>
    ...
    <div class="column2">
        ...
        <div class="wine-div2 col-xl-9 col-lg-7 col-md-7 col-sm-6 col-2">
          <img class="bottle col-8" src="{{ asset('img/tokai2.png') }}" width="90px" height="auto">
        </div>

      <div class="card5 mb-3 fluid-img">
        <div class="row g-0">
          <div class="col-md-4 col-sm-3 col-3 medals-div">
            <div><img src="{{ asset('img/international_trophy.png') }}" class="medals"></div>
            <div><img src="{{ asset('img/double-gold.png') }}" class="medals"></div>
            <div><img src="{{ asset('img/gran-gold.png') }}" class="medals"></div>
            <div><img src="{{ asset('img/silver.png') }}" class="medals"></div>
          </div>
